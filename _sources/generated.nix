...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  feeluown-ytmusic = {
    ...
    version = "0.4.1";
    src = fetchurl {
      url = "https://pypi.org/packages/source/f/fuo-ytmusic/fuo-ytmusic-0.4.1.tar.gz";
      sha256 = "sha256-sl3Tli0y4vgZeaxct5vtPnvmsLebl0HmgEh0+JsC8WY=";
    };
  };
  luoxu = {
    pname = "luoxu";
