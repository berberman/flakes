...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  feeluown-bilibili = {
    ...
    version = "0.3.2";
    src = fetchurl {
      url = "https://pypi.org/packages/source/f/feeluown-bilibili/feeluown-bilibili-0.3.2.tar.gz";
      sha256 = "sha256-PparL86aSfP2f3KzIeH/3ilqDyzuzcwAJLlRR7mMM7M=";
    };
  };
  feeluown-core = {
    pname = "feeluown-core";
    version = "4.0.1";
    src = fetchurl {
      url = "https://pypi.org/packages/source/f/feeluown/feeluown-4.0.1.tar.gz";
      sha256 = "sha256-R3fjmm+L0Ms7NwkitupXpoz1rBCXGhFERFjMN9qBDBs=";
    };
  };
  feeluown-kuwo = {
    pname = "feeluown-kuwo";
