...
}:
{
  ...
  fcitx5-pinyin-moegirl = {
    ...
    version = "20260412";
    src = fetchurl {
      url = "https://github.com/outloudvi/mw2fcitx/releases/download/20260412/moegirl.dict";
      sha256 = "sha256-YsdZU56dB0o1pV7SJG1/SMhShMoZmiSJ53jSsbph9gk=";
    };
  };
  ...
  feeluown-core = {
    ...
    version = "5.1.1";
    src = fetchurl {
      url = "https://pypi.org/packages/source/f/feeluown/feeluown-5.1.1.tar.gz";
      sha256 = "sha256-1sUuOi1i+ntPRmT0wqfXY/mfQf77SiY5scnuf3WY7Ec=";
    };
  };
  feeluown-kuwo = {
    pname = "feeluown-kuwo";
