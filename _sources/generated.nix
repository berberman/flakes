...
}:
{
  ...
  fcitx5-pinyin-moegirl = {
    ...
    version = "20260712";
    src = fetchurl {
      url = "https://github.com/outloudvi/mw2fcitx/releases/download/20260712/moegirl.dict";
      sha256 = "sha256-fCzh9pn+HWL60IvpPieaaZ+JjQZ1bbfYIyLEHDITK4U=";
    };
  };
  ...
  feeluown-core = {
    ...
    version = "5.1.2";
    src = fetchurl {
      url = "https://pypi.org/packages/source/f/feeluown/feeluown-5.1.2.tar.gz";
      sha256 = "sha256-phfhTYQbpZFCxXx43sdugdPWfuoW3h1YNVMxkr4iJOk=";
    };
  };
  feeluown-kuwo = {
    pname = "feeluown-kuwo";
