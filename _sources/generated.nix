...
{ fetchgit, fetchurl }:
{
  ...
  fcitx5-pinyin-moegirl = {
    ...
    version = "20210717";
    src = fetchurl {
      url = "https://github.com/outloudvi/mw2fcitx/releases/download/20210717/moegirl.dict";
      sha256 = "0v8v5kq7l1nnc9kmjid2r7liyalhmryyy7yg19d7529w6rb7hlpz";
    };
  };
  fcitx5-pinyin-zhwiki = {
    pname = "fcitx5-pinyin-zhwiki";
    version = "0.2.3.20210804";
    src = fetchurl {
      url = "https://github.com/felixonmars/fcitx5-pinyin-zhwiki/releases/download/0.2.3/zhwiki-20210804.dict";
      sha256 = "0fa3za236ravvmvjk0xl7n3n2m4fpk1svwc8sxz94pvaylxc4vac";
    };
  };
  feeluown-core = {
    pname = "feeluown-core";
  ...
  qasync = {
    ...
    version = "0.18.0";
    src = fetchurl {
      url = "https://pypi.io/packages/source/q/qasync/qasync-0.18.0.tar.gz";
      sha256 = "0wsj9aa1mk31z7x3z9qvz6623jndbmhnsp12zfn3a9mjjb07gx1k";
    };
  };
  qbittorrent-enhanced = {
    pname = "qbittorrent-enhanced";
    version = "release-4.3.6.10";
    src = fetchgit {
      url = "https://github.com/c0re100/qBittorrent-Enhanced-Edition";
      rev = "release-4.3.6.10";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
