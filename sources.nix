...
{ fetchgit, fetchurl }:
{
  ...
  fcitx5-pinyin-zhwiki = {
    ...
    version = "20210501";
    src = fetchurl {
      sha256 = "1qf8j4l71g76a1wv5f8rbrjspbmjp7ya3f3j4a2qyvmkpli4kxkg";
      url = "https://github.com/felixonmars/fcitx5-pinyin-zhwiki/releases/download/0.2.2/zhwiki-20210501.dict";
    };
  };
  feeluown-kuwo = {
    pname = "feeluown-kuwo";
